                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">
                              <h4 class="card-title">Invoice Franchise List</h4>                              
                          </div>
                          <br>
                                          ...
                                          $cnt=0;
                                            foreach ($allpoddata as $value) {
                                              $cnt++;
                                                ...
                                                <td>
                                                   <a href="<?php base_url();?>admin/show-edit-franchise-invoice/<?php echo $value['id']; ?>/<?php echo $value['customer_id']; ?>" ><i class="ion-edit" style="color:var(--primarycolor);"></i></a>|
                                                    ...
                                                    <a href="javascript:void(0)" onclick = "return theFunction(<?=$value['id']?>);"  title="Delete" ><i class="ion-trash-b" style="color:var(--danger)"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }

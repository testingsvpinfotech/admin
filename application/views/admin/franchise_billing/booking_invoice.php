                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">                               
                              <h4 class="card-title">View Franchise Invoice</h4>
                          </div>
                          <div class="card-body">
                            <div class="row">                                           
                          <div class="col-12">
                              <form role="form" action="<?php echo base_url(); ?>admin/list-domestic-billing" method="post" autocomplete="off">
                                  <div class="col-12">
                                    <div class="form-row">
											                        <div class="col-2 mb-3">
                                                <label for="username">Bill Type</label>
                                                <select class="form-control"  name="bill_type" id="bill_type" required>
													                        <option value="Credit" <?php if($_POST['bill_type']=='Credit'){echo 'selected';} ?>>Credit</option>
													                        <option value="Prepaid" <?php if($_POST['bill_type']=='Prepaid'){echo 'selected';} ?>>Prepaid</option>
                                                  </select>
                                                  <?php 
                                                  foreach($company_list AS $cl){ ?>
                                                  <input type ='hidden' name="company_id" required value="<?php echo $cl['id'];?>">
                                                  <?php } ?>
  ...
  $(".check_all").click(function(){
	...
	$("#branch_id").change(function (){
       ...
       //alert(bill_type) ;
         $.ajax({
				type: 'POST',
				url: '<?php echo base_url() ?>Franchise_customer_billing/getCustomer',

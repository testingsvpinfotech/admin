                  ...
                  <div class="col-12  align-self-center">
                      ...
                      <div class="card">
                          <div class="card-header justify-content-between align-items-center">
                              <h4 class="card-title">View Credit Prepaid Franchise Invoice List</h4>                              
                          </div>
                          <div class="card-body">
                                        ...
                                        if (!empty($allpoddata)) {
                                            foreach ($allpoddata as $value) {
                                              ...
                                              <tr <?php if($value['send_mail_status']=='1'){ ?> style="color:blue" <?php } ?>>
                                                ...
                                                <td><?php if(!empty($value['customer_name'])){echo $value['customer_name'];}else{echo $value['consigner_name'];} ?></td>
                                                <td><?php if(!empty($value['city'])){echo $value['city'];}else{ $id =$value['consigner_city']; echo $this->db->query("select * from city where id ='$id'")->row('city');} ?></td>
                                                <!-- <td><?php echo $value['city']; ?></td> -->
                                                <td><?php echo $value['gstno']; ?></td>
                                                <td><?php echo $value['cid']; ?></td>
                                                <td><?php echo $value['amount']; ?></td>
                                                <td>
                                                  <a title="Edit" href="<?php base_url();?>admin/show-edit-franchise-invoice/<?php echo $value['id'];?>/<?php echo $value['customer_id']; ?>" class="btn btn-primary"><i class="icon-pencil"></i></a>|
                                                  <a title="View" href="<?php base_url();?>admin/invoice-franchise-view/<?php echo $value['id'];?>/1" class="btn btn-success"><i class="icon-eye"></i></a>
                                                  <!-- | -->

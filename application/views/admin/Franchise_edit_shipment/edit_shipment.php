        ...
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 mr-auto">
                    <h5 class="mb-0">Edit Franchise Shipment</h5>
                </div>
            </div>
        </div>
    </div> -->
                ...
                <div class="col-12 col-md-12">
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="id1">
                               ...
                               <form  action="<?php echo base_url('admin/franchise-update-shipment/'.$booking->booking_id);?>" method="POST" id="formSubmit">
                <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="div_inv_row" style="display: none;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="number" name="invoice_value" id="invoice_value" step="any" value="<?= $booking->invoice_value ?>" class="form-control my-colorpicker1">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8" id="credit_div">
                                            <select class="form-control" name="customer_account_id" id="customer_account_id" disabled>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="sender_pincode" id="sender_pincode" value="<?= $booking->sender_pincode ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">State<span class="compulsory_fields">*</span></label>
                                        <div class="col-sm-8">
                                            <select class="form-control" id="sender_state" name="sender_state"  required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" id="sender_city"  name="sender_city"  required>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">Pincode<span class="compulsory_fields">*</span></label>
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" value="<?= $booking->reciever_pincode ?>" name="reciever_pincode" id="reciever_pincode" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">state<span class="compulsory_fields">*</span></label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="receiver_zone" id="receiver_zone"  value="<?= $booking->receiver_zone;?>" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="number" min="1" name="frieht" value="<?php echo $booking->frieht; ?>" class="form-control" required  id="frieht" />
                                                </div>
                                                <label class="col-sm-3 col-form-label">ODA Charge</label>
                                                <div class="col-sm-3">
                                                    <input type="number" name="delivery_charges" class="form-control"  value="<?php echo $booking->delivery_charges; ?>" id="delivery_charges">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">                                              
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="number"  class="form-control" name="fov_charges" id="fov_charges" value="<?php echo $booking->fov_charges; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">                                                
...
<div class="main"> <i style="float: right; margin-right:20px; margin-top:10px; font-size:17px;cursor:pointer;" id="close" class="fa fa-times" aria-hidden="true"></i>
  ...
  $("#reciever_pincode").on('blur', function () 
  {
    ...
    if (pincode != null || pincode != '') {
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url();?>Franchise_admin_edit_shipment/getCityList',
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url();?>Franchise_admin_edit_shipment/getState',
        data: 'pincode=' + pincode,
        dataType: "json",
        success: function (d) {         
          var option;         
  ...
  $("#reciever_state, #reciever_city").blur(function () 
	{
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url();?>Franchise_admin_edit_shipment/getZone',
	...
	//	alert(customer_name);
		if (customer_name != null || customer_name != '') 
		{
			$.ajax({
				type: 'POST',
				dataType: "json",
				url: '<?php echo base_url();?>Franchise_admin_edit_shipment/getsenderdetails',
